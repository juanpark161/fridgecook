            ...
            <>
              ...
              <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:8, marginBottom:20 }}>
                ...
                <button onClick={() => setPayMethod("apple")}
                  ...
                  <img src="https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg" style={{ width:16, height:16, filter: payMethod==="apple"?"invert(1)":"invert(0)", marginRight:5 }} />
                ...
                <button onClick={() => setPayMethod("paypal")}
                  ...
                  <img src="https://upload.wikimedia.org/wikipedia/commons/b/b5/PayPal.svg" style={{ height:16 }} />
                </button>
              </div>
              ...
              {payMethod === "apple" && (
                <div style={{ textAlign:"center", padding:"12px 0 8px" }}>
                  <div style={{ display:'flex', alignItems:'center', justifyContent:'center', gap:8, margin:'16px 0' }}><img src='https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg' style={{ width:32, height:32 }} /></div>
                  ...
                  <button onClick={submitApplePay} style={{ background:"#000", color:"#fff", border:"none", width:"100%", padding:"14px", borderRadius:12, cursor:"pointer", display:"flex", alignItems:"center", justifyContent:"center", gap:10, fontSize:15, fontWeight:600, fontFamily:"DM Sans, sans-serif" }}>
                    <img src="https://upload.wikimedia.org/wikipedia/commons/f/fa/Apple_logo_black.svg" style={{ width:18, height:18, filter:"invert(1)" }} />
                    Pay with Apple Pay
                  </button>
              ...
              {payMethod === "paypal" && (
                <div style={{ textAlign:"center", padding:"12px 0 8px" }}>
                  <div style={{ display:'flex', alignItems:'center', justifyContent:'center', margin:'16px 0' }}><img src='https://upload.wikimedia.org/wikipedia/commons/b/b5/PayPal.svg' style={{ height:28 }} /></div>
