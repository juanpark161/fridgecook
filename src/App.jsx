            ...
            <>
              ...
              <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:8, marginBottom:20 }}>
                ...
                <button onClick={() => setPayMethod("apple")}
                  ...
                  <img src="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/apple.svg" style={{ width:14, height:14, filter: payMethod==="apple"?"invert(1)":"invert(0)", marginRight:4 }} /><span style={{ fontSize:12, fontWeight:600, color: payMethod==="apple"?"#fff":"#333" }}>Apple Pay</span>
                </button>
              ...
              {payMethod === "apple" && (
                <div style={{ textAlign:"center", padding:"12px 0 8px" }}>
                  <img src="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/apple.svg" style={{ width:52, height:52, margin:"12px auto", display:"block" }} />
                  ...
                  <button onClick={submitApplePay} style={{ background:"#000", color:"#fff", border:"none", width:"100%", padding:"14px", borderRadius:12, cursor:"pointer", fontSize:15, fontWeight:600, fontFamily:"DM Sans, sans-serif" }}>
                    <img src="https://cdn.jsdelivr.net/gh/simple-icons/simple-icons/icons/apple.svg" style={{ width:18, height:18, filter:"invert(1)", marginRight:8 }} /> Pay with Apple Pay
                  </button>
